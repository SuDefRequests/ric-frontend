          ...
          <div className="flex flex-row items-center justify-between sm:justify-center gap-2 sm:gap-4 md:gap-6 w-full max-w-5xl px-2">
            ...
            <div className="flex flex-col items-center text-center">
              <span className={`text-[8.5px] sm:text-[11px] md:text-xs font-semibold tracking-wider uppercase leading-tight ${
                isHome ? 'text-blue-200' : 'text-[#1e3a8a]'
              }`}>
              ...
              <span className={`text-[7.5px] sm:text-[9.5px] md:text-[11px] font-semibold tracking-wide mt-0.5 ${
                isHome ? 'text-neutral-300' : 'text-[#1e3a8a]'
              }`}>
...
<div className="hidden lg:flex items-center justify-between border-t border-white/20 pt-3.5">
  {/* Left spacer to keep center balance */}
  <div className="w-28"></div>

  {/* Main Centered Navigation */}
  <nav className="flex items-center gap-6 xl:gap-8 text-[14px] md:text-[15px] font-semibold tracking-wide">
    {navItems.map((item) => {
    ...
    {/* Directly in place of "My Account" */}
    {user ? (
      <div className="relative ml-2" ref={dropdownRef}>
        ...
        >
          <div className="w-6 h-6 rounded-full bg-maroon text-white flex items-center justify-center font-bold text-[10px] shrink-0">
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-xs bg-maroon text-white px-3.5 py-1.5 rounded-full shadow hover:bg-maroon-dark font-bold uppercase tracking-wider transition border border-red-400/30 whitespace-nowrap cursor-pointer ml-2"
      >
  ...
  {/* Right spacer mirroring the left spacer */}
  <div className="w-28"></div>
</div>
